...
if (isset($_SESSION['sv_login'])) {
   ...
   if (isset($_SESSION['sv_chuatraphong'])) {
              ...
              <div class="form-row">
                 ...
                 <div class="form-group col-sm-4">
                  ...
                  <div class="form-group col-sm-4">
                    ...
                    <label class="form-control"><?php echo $maphong; ?></label>
                 </div>
               </div>

               <div class="form-group">
                
                 <label> <span style="color: red;font-size: 25px;">*</span>Lưu ý : Bạn sẽ không được nhận lại tiền dư khi trả phòng trước thời hạn. Nhân viên ký túc xá sẽ kiểm tra lại tài sản trước khi cho bạn trả phòng. Hệ thống sẽ gửi thông báo sau !. Nên đăng xuất tài khoản sau khi trả phòng để hệ thống cập nhật dữ liệu.</label>
              </div>
        <hr>
...
<?php }
  ...
  echo '<script>alert("Sinh viên đã trả phòng, đợi duyệt trả phòng hoặc chưa đăng ký phòng!.")</script>';
}
