          ...
          <h5 class="card-title text-center">Đăng Ký Phòng KÝ TÚC XÁ</h5><hr>
           ...
           <form class="col-md-12 m-auto" action="xuly/main.php?action=dangkychuyenphong" method="POST">
              ...
              <div class="form-group">
                 ...
                 <label>Hệ thống sẽ tự động chọn phòng cho bạn theo yêu cầu bạn đã chọn. Hệ thống sẽ gửi thông báo sau!</label>
              </div>
              <hr>
              <div class="form-group">
                 <caption>Đây là Thông Tin Giá Phòng:</caption>
                 <br><br>
