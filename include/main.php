 <div class="container-fluid">
        <dir class="row">
                    ...
                    <nav id="menu">
                        <ul>
                            <h3> CHỨC NĂNG </h3>
                                    ...
                                    <li><a href="index.php?action=guiphanhoi">Gửi Phản Hồi</a></li>
            ...
            <div class="col-2 nenbac">
               <div >
                    <img src="images/logo-dhcnda.png" width="200"
                         alt="Activities Board">
                    <center><h3 style="margin-top: 10px;"><a href="index.php?action=tintucktx" class="no_underline">
                        Tin tức KTX EAUT</center>
                    </a></h3>
                    <p class="news_item">Để biết thêm tin tức về Ký túc xá Trường Đại Học Công Nghệ Đông Á vui lòng click vào đường link ở phía trên để tiếp tục theo dõi tin tức! </p>
                </div>
